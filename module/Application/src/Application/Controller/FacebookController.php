...
class FacebookController extends AbstractActionController
{
    public function indexAction(){
        if(preg_match("/facebook/",$_SERVER['HTTP_USER_AGENT'])){
            ...
            $metaHelper->setProperty("og:description","1 Woche im TOP 4* Hotel in Ägypten / Hurghada mit Strandnähe, 6* Bewertung auf Holidaytest, All Inclusive, inkl. Flug + Transfer, diverse österreichische Abflughäfen - Überzeugt euch selbst und teilt dieses Schnäppchen!");
        }
        else{
