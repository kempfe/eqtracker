...
class FacebookController extends AbstractActionController
{
    public function indexAction(){
        if(preg_match("/facebook/",$_SERVER['HTTP_USER_AGENT'])){
            ...
            $metaHelper->setProperty("og:description","Superschnäppchen für die Hauptsaison! - TOP 4* Hotel in Ägypten / Hurghada direkt am Strand, Excellente!! Hotel Bewertung mit 6* auf Holidaytest, All Inclusive, inkl. Flug + Transfer, diverse österreichische Abflughäfen");
        }
        else{
